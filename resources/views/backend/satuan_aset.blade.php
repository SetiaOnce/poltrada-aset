@extends('backend.layouts', ['activeMenu' => 'SATUAN_ASET', 'activeSubMenu' => 'MASTERISASI', 'title' => 'Masterisasi Satuan Aset'])
@section('content')
@section('css')
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label required fw-bold fs-6" for="satuan_aset">Satuan Aset</label>
                        <div class="col-lg-8">
                            <input type="text" name="satuan_aset" id="satuan_aset" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" maxlength="50" placeholder="Isikan satuan aset ..." />
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Master Satuan Aset
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
...
<script src="{{ asset('/script/backend/satuan_aset.js') }}"></script>
@stop
@endsection