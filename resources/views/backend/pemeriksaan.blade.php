@extends('backend.layouts', ['activeMenu' => 'PEMERIKSAAN', 'activeSubMenu' => '', 'title' => 'Pemeriksaan Aset'])
@section('content')
@section('css')
...
<div class="card" id="card-form" style="display: none;">
    ...
    <form class="form" autocomplete="off" id="form-data">
        <input type="hidden" name="id"><input type="hidden" name="methodform_pemeriksaanAset">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="form-group mb-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="tanggal_pemeriksaan" name="tanggal_pemeriksaan" class="form-control " placeholder="Isi tanggal pemeriksaan aset...">
                        </div>
                    ...
                    <div class="form-group mb-5">
                        <label for="keterangan_pemeriksaan">Keterangan: <span class="text-danger">*</span></label>
                        <textarea id="keterangan_pemeriksaan" name="keterangan_pemeriksaan" class="form-control" placeholder="Isi keterangan perawatan..."></textarea>
                        <span class="form-text mt-3 text-muted">*) Isi dengan: <code>-</code> Jika tidak ada</span>
                    </div>

                    <div class="form-group mb-5" id="fg-fotoPemeriksaan">
                        <label for="foto_pemeriksaan">Foto Pmeriksaan: <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group mb-5" id="fg-filePdf">
                        <label for="file_pdf">File Pmeriksaan: <span class="text-danger">*</span></label>
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Pemeriksaan Aset
            </h3>
        </div>
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip" title="Tambah data pemeriksaan aset baru!" onclick="_addData();"><i class="las la-plus fs-3"></i> Tambah</button>
            </div>
        </div>
    </div>
    <!--end::Card header-->
    <div class="card-body">
        ...
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded align-middle table-row-bordered nowrap border" id="dt-pemeriksaanAset">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-light">
                        ...
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">Tgl.Pmeriksaan</th>
                        <th class="align-middle px-2 border-bottom-2 border-gray-200">Foto Pmeriksaan</th>
...
<script src="{{ asset('/script/backend/pemeriksaan_aset.js') }}"></script>
@stop
@endsection
