                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5 avatar-header">
                                    ...
                                    {{-- <img src="https://kepegawaian.exprodi.co.id/storage/pegawai/2ae1ee3a66821d8166fb98465c4f1dd9-foto.png" alt=""> --}}
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <!--end::Menu separator-->
                            ...
                            <a href="{{ url('app_admin/user_profile') }}" class="menu-link px-5">
